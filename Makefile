...
build : clean $(OUTPUT_DIR)/Osek_pi_crunch_cm3.elf

all : clean $(OUTPUT_DIR)/Osek_pi_crunch_cm3.elf
...
$(OUTPUT_DIR)/Osek_pi_crunch_cm3.elf : $(FILES_O)
	@$(LD) $(LOPS) $(FILES_O) -o $(OUTPUT_DIR)/Osek_pi_crunch_cm3.elf
	@$(OBJCOPY) $(OUTPUT_DIR)/Osek_pi_crunch_cm3.elf -O ihex $(OUTPUT_DIR)/Osek_pi_crunch_cm3.hex
	@$(NM) --numeric-sort --print-size $(OUTPUT_DIR)/Osek_pi_crunch_cm3.elf | $(CPPFILT) > $(OUTPUT_DIR)/OSEK_cppfilt.txt
